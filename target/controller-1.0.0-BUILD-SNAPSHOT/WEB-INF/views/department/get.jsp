        ...
        function showUploadResult(uploadResultArr){
            ...
            $(uploadResultArr).each(function(i, obj){
                if(obj.image){
                    ...
                    str += "<div class='col-sm-12 col-md-1' data-path='"+obj.uploadPath+"' data-uuid='"+obj.uuid+"' data-filename='"+obj.fileName+"' data-type='"+obj.image+"'><div>";
            ...
            $.getJSON("/board/getAttachList", {bno: bno}, function(arr){
                ...
                $(arr).each(function(i, attach){
                    if(attach.fileType){
                        ...
                        str += "<div class='col-sm-12 col-md-1' data-path='"+attach.uploadPath+"' data-uuid='"+attach.uuid+"' data-filename='"+attach.fileName+"' data-type='"+attach.fileType+"' ><div>";
                        str += "<img src='/upload/display?fileName="+fileCallPath+"'>";
                        str += "</div></div>";
                    }else{
                        str += "<div class='col-sm-12 col-md-1' data-path='"+attach.uploadPath+"' data-uuid='"+attach.uuid+"' data-filename='"+attach.fileName+"' data-type='"+attach.fileType+"' ><div>";
